...
-   ### User stories
    ...
    -   #### First Time Visitor Goals
        ...
        2. As a First Time Visitor, I want to be able to easily navigate throughout the site to find the art images.
    ...
    -   #### Frequent Visitor Goals
        ...
        1. As a Frequent User, I want to check to see if there are any newly added works of art.
        2.  As a Frequent User, I want to check to see if there is any news of exhibitions when the website has evolved.
   
-   ### Design
    
    -   #### Colour Scheme
        
        -   The main colours used are black, grey, yellow and blue with space inspired backgrounds.
    -   #### Typography
        
        -   The Orbitron font is the main font used throughout the whole website with Sans Serif as the fallback font in case for any reason the font isn't being imported into the site correctly. Orbitron is from Google Fonts, and has a space-feeling to it, so it really works well with the theme of this website.
    -   #### Imagery
...
after some guidance from my Code mentor, the background was changed to match the space theme, as they fit in so much better with the themeof the art. It also does not collide with the art itself, nor does it distract from it, but enhances it.
    ...
    - [View the original wireframe here](documentation/assets/images/wireframe.jpeg)
...
1. As a First Time Visitor, I want the user to feel like they have just entered space as soon as they go on the home page.
	...
	2. The focal point of the page, contains the artists´s pen name, underneath which contains some non-functioning tabs as decoration to describe
the themes the artist is interested in and uses as inspiration for his art. The user has two options, click on the nav bar to go to another page,
or hover over the footer where three social media platforms are provided, to choose the one they want to go to.

2. As a First Time Visitor, I want to be able to easily navigate throughout the site to find the art images.

	1. From the nav bar, gallery is the third option, Gallery. Once clicked, the user is taken to the art.

	2. Under Gallery are 9 pieces showcased.
...
3. As a First Time Visitor, I want to be able to find a way to learn more about the artist and easily contact the artist directly.
	...
	2. The contact page is very simple, but gives the user the opportunity to send a message to the artist, whether they would like to know about upcoming exhibitions or if the person is interested in buying any of the art.
...
-   #### Frequent User Goals
    ...
    1.  As a Frequent User, I want to check to see if there are any newly added works of art. 
        ...
        1.  The user would already be comfortable with the website layout and can easily find the gallery page again. 
    2.  As a Frequent User, I want to check to see if the website has evolved to include blog posts or news of upcoming exhibitions. 
        

### Further Testing

-   The Website was tested on Google Chrome, Internet Explorer, and Safari browsers.
-   The website was viewed on a variety of devices such as Desktop, Laptop, iPhoneS and Samsung Gallaxy. 
